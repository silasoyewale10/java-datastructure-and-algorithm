...
public class RepeatedWordTest {
    ...
    public void test3(){
        ...
        assertEquals(expected, xx.repeatedWord("It was a queer sultry summer the summer they electrocuted the Rosenbergs and I didnt know what I was doing in New York"));
    }
}